...
void form4::ini_results(std::vector<float> &results_operation){
    ...
    // ---------------------------------------------------- multiplication level one------------------------------------------------------
      if(i >= 0 && i < 45){
            ...
            if(n1 != vt_values.at(i) && n2 != vt_values.at(i)){
                multip_result = n1 * n2;
                multiplication_level_one(multip_result);
   ...
   // ------------------------------------------------------ multiplication level two------------------------------------------------------
    if(i > plays){
        ...
        if(n1 != vt_values.at(i) && n2 != vt_values.at(i) && n3 != vt_values.at(i)){
            multip_result = n1 * n2 * n3;
            multiplication_level_two(multip_result);
...
void form4::on_lineEdit_c1_textEdited(float &arg1)
{
    arg1 = ui->lineEdit_c1->text().toFloat();
}

void form4::on_lineEdit_c2_textEdited(float &arg1)
{
    arg1 = ui->lineEdit_c2->text().toFloat();
}

void form4::on_lineEdit_c3_textEdited(float &arg1)
{
    arg1 = ui->lineEdit_c3->text().toFloat();
}

void form4::on_lineEdit_c4_textEdited(float &arg1)
{
    arg1 = ui->lineEdit_c4->text().toFloat();
}

void form4::on_lineEdit_c5_textEdited(float &arg1)
{
    arg1 = ui->lineEdit_c5->text().toFloat();
}

void form4::multiplication_level_one(float multip){

    if(multip == vt_values.at(i)){
...
void form4::multiplication_level_two(float multip){
